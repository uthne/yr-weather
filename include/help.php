...
function codex_wpyr_help_tab() {
	...
	. '<p>' . __('This plugin is provided as full version, free-to-use under Creative Commons (CC) license. The yr.no weather service is a governmental service financed for by Norwegian tax-payers and are free to use under Creative Commons license.', 'yr-weather') . '</p>'
	. '<p>' . __('The weather symbols "outline" and "black" are made by the author of this plugin, and published under Creative Commons. The symbols are loosely based on the weather icons provided by the yr.no weather service. The color weather icons are property of yr.no weather service and published under free-to-use MIT license on <a href="https://github.com/nrkno/yr-weather-symbols">GitHub</a>.', 'yr-weather') . '<br />&nbsp;</p>'
