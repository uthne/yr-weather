...
<select name='wpyr_settings[wpyr_gen_offset_select]'>
	<option value="0"<?php if($options['wpyr_gen_offset_select'] == "0") echo(' selected'); ?>><?php _e('Now','yr-weather'); ?></option>
	<?php for ($i = 1; $i < 48; $i++) { ?>
	<option value="<?php echo($i); ?>"<?php if($options['wpyr_gen_offset_select'] == $i) echo(' selected'); ?>><?php echo($i); ?></option>
	<?php } ?>
</select>&nbsp;	
...
function wpyr_template_html_area_render() { 
	global $wpyr_default_css;
	$options = wpyr_get_option();
	?>
...
function wpyr_template_loop_checkbox_render() { 
	$options = wpyr_get_option();
	?>
<input type='checkbox' name='wpyr_template_settings[wpyr_template_loop_checkbox]' 
	<?php if(isset( $options['wpyr_template_loop_checkbox'])) checked( $options['wpyr_template_loop_checkbox'], 1 ); ?> value='1'>&nbsp;
...
<table>
  <tbody>
    <tr>
	  ...
	  <?php _e("These are the shortcodes and attributes for Yr Weather.","yr-weather" ); ?><br />&nbsp;<br /><strong>
	  
    </tr>
    <tr>
      <th align="left"  scope="row" valign="top"  width="15%">[wpyr_weather]</th>
      <td valign="top"><?php _e("Using the shortcode without any attributes will render the weather forecast as defined in the shortcode settings. You can however add several variables, or attributes to override these settings","yr-weather"); ?><br />&nbsp;
		  <table>
			  <tr><th align="left"  scope="row" valign="top"  width="15%">place</th><td  valign="top"><?php _e("Set the location for the weather forecast. See help-tab in upper right corner for more information on how to obtain correct location.","yr-weather"); ?></td></tr>
			  <tr><th align="left"  scope="row" valign="top"  width="15%">offset</th><td  valign="top"><?php _e('You can offset the time of forecast from 0 to 47 hours, i.e offset="24".',"yr-weather"); ?></td></tr>
			  <tr><th align="left"  scope="row" valign="top"  width="15%">icon</th><td  valign="top"><?php _e("Use this to select the icon set. You can choose <em>thin</em>, <em>normal</em>, <em>fat</em>, <em>black</em> or <em>color</em>.","yr-weather"); ?></td></tr>
			  <tr><th align="left"  scope="row" valign="top"  width="15%">width</th><td  valign="top"><?php _e("The width of the icon, use any CSS definition, like <em>100px</em>, <em>100%</em> or <em>25vw</em>.","yr-weather"); ?></td></tr>
			  <tr><th align="left"  scope="row" valign="top"  width="15%">height</th><td  valign="top"><?php _e("The height of the icon, use any CSS definition except %, like <em>100px</em>, <em>10em</em> or <em>auto</em>.","yr-weather"); ?></td></tr>
			  <tr><th align="left"  scope="row" valign="top"  width="15%">smallicon</th><td  valign="top"><?php _e("Icon set for symbols like temperature, wind, direction, barometer, precipitation etc in your template. You can choose <em>thin</em>, <em>normal</em>, <em>fat</em>, <em>black</em> or <em>color</em>.","yr-weather"); ?></td></tr>
			  <tr><th align="left"  scope="row" valign="top"  width="15%">smallwidth</th><td  valign="top"><?php _e("The width of the smallicon, use any CSS definition, like <em>100px</em>, <em>100%</em> or <em>25vw</em>.","yr-weather"); ?></td></tr>
			  <tr><th align="left"  scope="row" valign="top"  width="15%">smallheight</th><td  valign="top"><?php _e("The height of the smallicon, use any CSS definition except %, like <em>100px</em>, <em>10em</em> or <em>auto</em>.","yr-weather"); ?></td></tr>
			  <tr><th align="left"  scope="row" valign="top"  width="15%">mask</th><td  valign="top"><?php _e("<em>yes</em> or <em>no</em> if the icon should be used as a color mask.","yr-weather"); ?></td></tr>
			  <tr><th align="left"  scope="row" valign="top"  width="15%">color</th><td  valign="top"><?php _e("The color to be applied to the icon color mask. Use CSS definition such as <em>#ff0000</em> or <em>rgba(255,0,0,0.5)</em>","yr-weather"); ?></td></tr>
		  </table><br>
		  <em style="color:blue"><?php _e('[wpyr_weather place="Norway/Oslo/Oslo/Oslo" offset="3" icon="fat" width="200px" height="200px" mask="yes" color="rgba(0,0,0,0.5)"]',"yr-weather"); ?></em>
		<br />&nbsp;</td>
    </tr>
    <tr>
      <th align="left"  scope="row" valign="top"  width="15%">[wpyr_weather <br>offset="0" <br>end="47"]</th>
      <td valign="top"><?php _e("Use the same shortcode but add the <em>end</em> attribute with the <em>offset</em> attribute to make a loop/sequence of forecasts. You can use all the other attributes in a loop shortcode as well. There will only be one call to the yr.no to collect weather data for a loop/sequence","yr-weather"); ?> <br />&nbsp;
		<table width=100%>
			  <tr><th align="left"  scope="row" valign="top"  width="15%">offset</th><td  valign="top"><?php _e('You can offset the start of forecast from 0 to 47 hours, i.e offset="6".',"yr-weather"); ?></td></tr>
			  <tr><th align="left"  scope="row" valign="top"  width="15%">end</th><td  valign="top"><?php _e('Number of hours to the last forecast from 0 to 47 hours, i.e end="18".',"yr-weather"); ?></td></tr> 
			  <tr><th align="left"  scope="row" valign="top"  width="15%">interval</th><td  valign="top"><?php _e('Number of hours between each forecast, i.e interval="2".',"yr-weather"); ?></td></tr> 
		  </table><br>
		  <em style="color:blue"><?php _e('[wpyr_weather offset="6" end="18" interval="2"]',"yr-weather"); ?></em>
		<br />&nbsp;</td>
    </tr>
  </tbody>
</table> <?php
