...
function wpyr_gen_offset_select_render() { 
	...
	<?php _e( 'Hours offset to forecast.','yr-weather' ); 
}
function wpyr_gen_icon_select_render() { 
	...
	<?php _e( 'Select icon set to use as standard.','yr-weather' ); 
}
...
function wpyr_gen_smallicon_select_render() { 
	...
	<?php _e( 'Icon set for symbols like temperature, wind, direction, barometer, precipitation etc.','yr-weather' ); 
}
...
function wpyr_gen_colorfilter_checkbox_render() { 
	...
	<?php _e( 'Add color to icon.','yr-weather' ); 
}
...
function wpyr_gen_reset_checkbox_render() { 
	...
	<?php _e( 'Check to force default options when plugin is deactivated and reactivated.','yr-weather' ); 
}
...
function wpyr_template_css_area_render() { 
	...
	<textarea style="display:none;" id="wpyr_template_css_area" name="wpyr_template_settings[wpyr_template_css_area]">
		<?php if(!isset($options['wpyr_template_css_area']) || $options['wpyr_template_css_area'] != '' ) echo $options['wpyr_template_css_area']; ?>
	</textarea>
    <em>
		<?php _e( 'This CSS will be written to the &lt;head&gt; tag, but for optimized performance it is best practice to implement CSS-code in your theme.','yr-weather' ); ?>
	</em><br> 
		<?php
}
function wpyr_template_html_area_render() { 
	...
	<textarea style="display:none;" id="wpyr_template_html_area" name='wpyr_template_settings[wpyr_template_html_area]'>
		<?php if(!isset($options['wpyr_template_html_area']) || $options['wpyr_template_html_area'] != '' ) echo $options['wpyr_template_html_area']; ?>
	</textarea><br/>
	<strong>
		<?php _e( 'Use these tags to include weather data in your layout:','yr-weather' ); ?>
	</strong><br>
	[@symbol] [@symbol-url] [@place] [@date] [@date-time] [@time-from] [@time-to] [@offset] [@offset-lowercase]<br>
	...
	<strong>
		<?php _e( 'Translatable texts (also with first letter capitalized):','yr-weather' ); ?>
	</strong><br>
	[time] [from] [to] [and] [in] [at] [hour] [hours] [place] [precipitation] [wind] [windspeed] [wind-direction]<br>
...
function wpyr_template_loop_area_render() { 
	...
	<textarea style="display:none;" id="wpyr_template_loop_area" name='wpyr_template_settings[wpyr_template_loop_area]'>
		<?php if(!isset($options['wpyr_template_loop_area']) || $options['wpyr_template_loop_area'] != '' ) echo $options['wpyr_template_loop_area']; ?>
	</textarea><br/>
	<strong>
		<?php _e( 'Use all tags above, and the following to mark start and end of loop:','yr-weather' ); ?>
	</strong><br>
	[@loop-start] [@loop-end] <br><br>
		<?php
}
function wpyr_template_loop_checkbox_render() { 
	...
	<?php _e( 'Use single template in loop shortcode.','yr-weather' ); 
}
